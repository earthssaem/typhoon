...
const ROLE: Record<Tab, string> = {
  map: '주변의 전체적인 기압 배치·바람·기온을 읽습니다.',
...
const HOWTO: Record<Tab, string[]> = {
  map: [
    ...
    '일기기호(관측소 기호)에서 기온을 읽어 보세요. 동그라미 왼쪽 위의 빨간 숫자가 그 지점의 기온(℃)이고, 동그라미에 붙은 깃은 바람의 방향·세기를 나타냅니다.',
  ],
  satellite: [
...
const PROMPTS: Record<Tab, { id: string; q: string; opts: string[] }[]> = {
  map: [
    ...
    { id: 'm3', q: '목적지의 예상 기온은?', opts: ['18℃ 미만', '18~22℃', '22~26℃', '26℃ 이상', '잘 모르겠음'] },
  ],
  satellite: [
